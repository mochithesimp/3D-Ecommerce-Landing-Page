...
import { WavyCircles } from "./WaveCircles";
...
const Carousel = ({ slice }: CarouselProps): JSX.Element => {
  ...
  function changeFlavor(index: number) {
    ...
    tl.to(
      ...
      .to(
        {},
        { onStart: () => setCurrentFlavorIndex(nextIndex) }, 0.5
      )
...
function ArrowButton({ label, onClick, direction = "right" }: ArrowButtonProps) {
  ...
  return (
    <button onClick={onClick} className="size-12 rounded-full border-2 border-white bg-white/10 p-3 opacity-85 ring-white focus:outline-none focus-visible:opacity-100 focus-visible:ring-4 md:size-16 lg:size-16">
